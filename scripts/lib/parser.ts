...
export function parseHtml(_html: string, _act: ActIndexEntry): ParsedAct {
  throw new Error(
    'Parser not yet implemented for Cameroon. ' +
    'Implement this function to parse HTML from minjustice.gov.cm.'
  );
}
