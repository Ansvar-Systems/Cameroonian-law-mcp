...
**The Cameroon Law alternative for the AI age.**

[![npm version](https://badge.fury.io/js/%40ansvar/cameroon-law-mcp.svg)](https://www.npmjs.com/package/@ansvar/cameroon-law-mcp)
[![MCP Registry](https://img.shields.io/badge/MCP-Registry-blue)](https://registry.modelcontextprotocol.io)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![GitHub stars](https://img.shields.io/github/stars/Ansvar-Systems/Cameroon-law-mcp?style=social)](https://github.com/Ansvar-Systems/Cameroon-law-mcp)
[![CI](https://github.com/Ansvar-Systems/Cameroon-law-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/Cameroon-law-mcp/actions/workflows/ci.yml)
...
Query **494 Cameroonian Acts** -- from the Data Protection Act and Computer Misuse and Cybercrimes Act to the Companies Act, Constitution of Cameroon, and more -- directly from Claude, Cursor, or any MCP-compatible client.
...
Cameroonian legal research is scattered across Cameroon Law Reports, the Cameroon Gazette, and various government portals. Whether you're:
- A **lawyer** validating citations in a brief or contract under Cameroonian law
- A **compliance officer** checking if the Data Protection Act 2019 provisions apply to your processing activities
- A **legal tech developer** building tools on Cameroonian legislation
...
**Endpoint:** `https://cameroon-law-mcp.vercel.app/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add cameroon-law --transport http https://cameroon-law-mcp.vercel.app/mcp` |
...
```json
{
  "mcpServers": {
    "cameroon-law": {
      "type": "url",
      "url": "https://cameroon-law-mcp.vercel.app/mcp"
    }
  }
}
```
...
```json
{
  "mcpServers": {
    "cameroon-law": {
      "command": "npx",
      "args": ["-y", "@ansvar/cameroon-law-mcp"]
    }
  }
}
```
...
- *"What does the Constitution of Cameroon say about the right to privacy?"*
- *"Search for data breach notification requirements in Cameroonian law"*
- *"What are the obligations under the National Payment Systems Act?"*
- *"Validate this legal citation"*
- *"Build a legal stance on personal data processing in Cameroon"*
...
| **Cameroon Information and Communications Act** | 1998 (amended) | Regulates telecommunications and ICT sector; establishes the Communications Authority of Cameroon |
...
| **Constitution of Cameroon** | 2010 | Supreme law; Article 31 guarantees the right to privacy |
...
**Estimated database size:** ~80-150 MB (full corpus of Cameroonian federal legislation)
...
| `format_citation` | Format citations per Cameroonian conventions (full/short/pinpoint) |
...
| Tool | Description |
|------|-------------|
| `get_eu_basis` | Get EU directives/regulations for Cameroonian statute |
| `get_cameroonian_implementations` | Find Cameroonian laws implementing EU act |
| `search_eu_implementations` | Search EU documents with Cameroonian implementation counts |
...
- All statute text is ingested from official Cameroonian government sources
...
- **[Cameroon Law Reports](https://cameroonlaw.org)** -- Official Cameroonian government legal database
...
>
> Statute text is sourced from official Cameroonian government publications. However:
...
```bash
git clone https://github.com/Ansvar-Systems/Cameroon-law-mcp
cd Cameroon-law-mcp
npm install
npm run build
npm test
...
**30+ national law MCPs** covering Australia, Brazil, Canada, China, Denmark, Finland, France, Germany, Ghana, Iceland, India, Ireland, Israel, Italy, Japan, Cameroon, Netherlands, Nigeria, Norway, Singapore, Slovenia, South Korea, Sweden, Switzerland, Thailand, UAE, UK, and more.
...
```bibtex
@software{cameroon_law_mcp_2025,
  author = {Ansvar Systems AB},
  title = {Cameroonian Law MCP Server: AI-Powered Legal Research Tool},
  year = {2025},
  url = {https://github.com/Ansvar-Systems/Cameroon-law-mcp},
  note = {Cameroonian legal database with full-text search and EU cross-references}
}
```
...
- **Statutes & Legislation:** Cameroonian Government (public domain)
